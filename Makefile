...
test-enc: all
	$(MAIN_EXEC) -m enc -f ./IOfile/plaintext.txt -o ./IOfile/enc_rst.fde -k ./IOfile/rsa.pub -a rsa -s sm4

test-dec: all
	$(MAIN_EXEC) -m dec -f ./IOfile/enc_rst.fde -k ./IOfile/rsa.key -o ./IOfile/dec_rst.txt
