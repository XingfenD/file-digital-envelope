...
#include <stdint.h>
    ...
    #define TABLES_AES_MOD
         ...
         * #define POLY 0x11B
         *
         * unsigned char gf_multiply(unsigned char LEF, unsigned char RIG) {
         ...
         */
        static const unsigned char AES_S_Box1[16][16] = {
         ...
         */
        static const unsigned char AES_S_Box2[16][16] = {
         ...
         */
        static const unsigned char AES_MixCol_Mat[4][4] = {
            { 0x02, 0x03, 0x01, 0x01 },
            { 0x01, 0x02, 0x03, 0x01 },
            { 0x01, 0x01, 0x02, 0x03 },
            { 0x03, 0x01, 0x01, 0x02 }
         ...
         * the elements of this mat will be used as the arg LEF in macro:AES_MAT_MUL
         */
        static const unsigned char AES_deMixCol_Mat[4][4] = {
            { 0x0E, 0x0B, 0x0D, 0x09 },
            { 0x09, 0x0E, 0x0B, 0x0D },
            { 0x0D, 0x09, 0x0E, 0x0B },
            { 0x0B, 0x0D, 0x09, 0x0E }
         ...
         */
        static const unsigned char AES_MixCol_Rst1[3][256] = {
            /* 0x01 */
         ...
         */
        static const unsigned char AES_MixCol_Rst2[6][256] = {
            /* 0x09 */
